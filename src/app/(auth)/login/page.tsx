            ...
            <div className="inline-flex rounded-lg border border-border p-1">
              {(['authenticator', 'email'] as const).map((m) => (
                <button
                  ...
                  className={`rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${mfaMethod === m ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                >
